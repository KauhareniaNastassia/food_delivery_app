...
class AppColors {
  ...
  static const Color errorBackgroundColor = Color(0xFFD97778);
  ...
  static const Color titleGreyTextColor = Color(0xFF9B9BA9);
  static const Color titleDarkGreyTextColor = Color(0xFFBABABE);
